...
public class TextClassifier1 {

  static String confusionMatrix = new String();
  ...
  public String getConfusionMatrix() {
     ...
     /* String[] inputText =  {":)", "happy", "good", "very good","super","awesome",":(","worst","bad", "very bad"};

      
      String[] inputClasses = {"satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied"};*/
 String[] inputText =  {":)", "happy", "good", "very good","super","awesome","amazing","best","super","brilliant","nice","great","gr8","gud","nyc"," :(","worst","bad", "very bad","not","not good","not happy","dissatisfied","not satisfied","unhappy","pathetic","idiotic","fake","delay","ok","fine","average","mediocre","okayish","okish","k","wokay"};

      
      String[] inputClasses = {"satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","satisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","dissatisfied","neutral","neutral","neutral","neutral","neutral","neutral","neutral","neutral"};
      String[] testText = ReadLinesFromFile.returnListOfListStrings();
      /*String[] testText = {
    		  "Ya no est� la chromebook dell 13 en amazon :O A m� que no me gusta comprar impulsivamente, ahora me arrepiento de no haberlo hecho :(",
    		  "@ADATATechnology @Newegg @NeweggHotDeals Still no sx7000.:( but did see amazon had a couple in stock",
    		  "I would try to buy imfact merch like lightsticks and stuff but my mom doesn't let me buy anything online unless it's from amazon I'm :((",
    		  "Selling. PayPal & Amazon Only!DM me if Interested :) https://t.co/blcQCJFeOS",
    		  "We are live on @amazon! Free two day shipping for Prime Customers in the US! :) https://t.co/ZnXmLOZdm2 https://t.co/mWC",
    		  "And my new Nike running shoes :)",
    		  ":) and thanks for reviewing my book The Capuchin https://t.co/FvKVJRUJkX teaches Catholic!",
    		  "Hello @amazon! :) #dontworrybehapbee"
      ...
      */
      ...
      TextClassifier1 classifier = new TextClassifier1(inputText, inputClasses, thisAttributeInfo, thisTextAttribute, thisClassAttribute, thisClassString);
  ...
  // constructor
  //
  public TextClassifier1(){}
  
  TextClassifier1(String[] inputText, String[] inputClasses, FastVector attributeInfo, Attribute textAttribute, Attribute classAttribute, String classString) {
  ...
  public static StringBuffer printClassifierAndEvaluation(Classifier thisClassifier, Evaluation thisEvaluation) {
      ...
      try {
          ...
          confusionMatrix = thisEvaluation.toMatrixString()+"\n";
